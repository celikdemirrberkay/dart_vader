...
extension DartVader on BuildContext {
  ...
  @Deprecated(
      'Directly screen size access deprecated. Use context.screenSizes.screenWidht instead.')
  double get screenWidht => MediaQuery.of(this).size.width;

  /// Returns screen height info
  @Deprecated(
      'Directly screen size access deprecated. Use context.screenSizes.screenHeight instead.')
  double get screenHeight => MediaQuery.of(this).size.height;

  /// Dynamic width
  @Deprecated(
      'Directly screen size access deprecated. Use context.screenSizes.dynamicWidth instead.')
  double dynamicWidth(double val) => screenWidht * val;

  /// Dynamic height
  @Deprecated(
      'Directly screen size access deprecated. Use context.screenSizes.dynamicHeight instead.')
  ...
  @Deprecated(
      'Directly text style access deprecated. Use context.textStyles.bodySmall instead.')
  TextStyle? get bodySmall => Theme.of(this).textTheme.bodySmall;

  /// Theme.of(context).textTheme.bodyMedium shortcut
  @Deprecated(
      'Directly text style access deprecated. Use context.textStyles.bodyMedium instead.')
  TextStyle? get bodyMedium => Theme.of(this).textTheme.bodyMedium;

  /// Theme.of(context).textTheme.bodyLarge shortcut
  @Deprecated(
      'Directly text style access deprecated. Use context.textStyles.bodyLarge instead.')
  TextStyle? get bodyLarge => Theme.of(this).textTheme.bodyLarge;

  /// Theme.of(context).textTheme.headlineSmall shortcut
  @Deprecated(
      'Directly text style access deprecated. Use context.textStyles.headlineSmall instead.')
  TextStyle? get headlineSmall => Theme.of(this).textTheme.headlineSmall;

  /// Theme.of(context).textTheme.headlineMedium shortcut
  @Deprecated(
      'Directly text style access deprecated. Use context.textStyles.headlineMedium instead.')
  TextStyle? get headlineMedium => Theme.of(this).textTheme.headlineMedium;

  /// Theme.of(context).textTheme.headlineLarge shortcut
  @Deprecated(
      'Directly text style access deprecated. Use context.textStyles.headlineLarge instead.')
  ...
  /// FontWeight w100
  @Deprecated(
      'Directly font weight access deprecated. Use context.fontWeights.fontWeight100 instead.')
  FontWeight get fontWeight100 => FontWeight.w100;

  /// Font weight w200
  @Deprecated(
      'Directly font weight access deprecated. Use context.fontWeights.fontWeight200 instead.')
  FontWeight get fontWeight200 => FontWeight.w200;

  /// Font weight w300
  @Deprecated(
      'Directly font weight access deprecated. Use context.fontWeights.fontWeight300 instead.')
  FontWeight get fontWeight300 => FontWeight.w300;

  /// Font weight w400
  @Deprecated(
      'Directly font weight access deprecated. Use context.fontWeights.fontWeight400 instead.')
  FontWeight get fontWeight400 => FontWeight.w400;

  /// Font weight w500
  @Deprecated(
      'Directly font weight access deprecated. Use context.fontWeights.fontWeight500 instead.')
  FontWeight get fontWeightw500 => FontWeight.w500;

  /// Font weight w600
  @Deprecated(
      'Directly font weight access deprecated. Use context.fontWeights.fontWeight600 instead.')
  FontWeight get fontWeightw600 => FontWeight.w600;

  /// Font weight w700
  @Deprecated(
      'Directly font weight access deprecated. Use context.fontWeights.fontWeight700 instead.')
  FontWeight get fontWeight700 => FontWeight.w700;

  /// Font weight bold
  @Deprecated(
      'Directly font weight access deprecated. Use context.fontWeights.fontWeightBold instead.')
  ...
  @Deprecated(
      'Directly platform access deprecated. Use context.platforms.isAndroid instead.')
  bool get isAndroid => Platform.isAndroid;

  /// If platform is iOS return true else false.
  @Deprecated(
      'Directly platform access deprecated. Use context.platforms.isIOS instead.')
  bool get isIOS => Platform.isIOS;

  /// If platform is Windows return true else false.
  @Deprecated(
      'Directly platform access deprecated. Use context.platforms.isWindows instead.')
  bool get isWindows => Platform.isWindows;

  /// If platform is MacOS return true else false.
  @Deprecated(
      'Directly platform access deprecated. Use context.platforms.isMacOS instead.')
  bool get isMacos => Platform.isMacOS;

  /// If platform is Fuchsia return true else false.
  @Deprecated(
      'Directly platform access deprecated. Use context.platforms.isFuchsia instead.')
  bool get isFuchsia => Platform.isFuchsia;

  /// If platform is Linux return true else false.
  @Deprecated(
      'Directly platform access deprecated. Use context.platforms.isLinux instead.')
  ...
  @Deprecated(
      'Directly time component access deprecated. Use context.times.currentTime instead.')
  DateTime get currentTime => DateTime.now();

  /// Returns zero duration.
  @Deprecated(
      'Directly time component access deprecated. Use context.times.zeroDuration instead.')
  Duration get zeroDuration => Duration.zero;

  /// Returns one second duration.
  @Deprecated(
      'Directly time component access deprecated. Use context.times.oneSecondDuration instead.')
